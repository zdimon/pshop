...
urlpatterns = patterns('',
    # Examples:
     ...
     url(r'^yandex_63cbe86113ecabf7.html$', lambda r: HttpResponse('''<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"></head><body>Verification: 63cbe86113ecabf7</body></html>''', mimetype="text/html")) 
