...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CurrencyHistory.dram2usd'
        db.alter_column(u'catalog_currencyhistory', 'dram2usd', self.gf('django.db.models.fields.DecimalField')(max_digits=8, decimal_places=4))

        # Changing field 'CurrencyHistory.rub2dram'
        db.alter_column(u'catalog_currencyhistory', 'rub2dram', self.gf('django.db.models.fields.DecimalField')(max_digits=8, decimal_places=4))

    def backwards(self, orm):

        # Changing field 'CurrencyHistory.dram2usd'
        db.alter_column(u'catalog_currencyhistory', 'dram2usd', self.gf('django.db.models.fields.DecimalField')(max_digits=4, decimal_places=4))

        # Changing field 'CurrencyHistory.rub2dram'
        db.alter_column(u'catalog_currencyhistory', 'rub2dram', self.gf('django.db.models.fields.DecimalField')(max_digits=4, decimal_places=4))
