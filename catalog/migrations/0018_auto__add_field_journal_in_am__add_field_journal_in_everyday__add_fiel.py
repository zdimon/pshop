...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Journal.in_am'
        db.add_column(u'catalog_journal', 'in_am',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Journal.in_everyday'
        db.add_column(u'catalog_journal', 'in_everyday',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Journal.in_pressa'
        db.add_column(u'catalog_journal', 'in_pressa',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Journal.in_am'
        db.delete_column(u'catalog_journal', 'in_am')

        # Deleting field 'Journal.in_everyday'
        db.delete_column(u'catalog_journal', 'in_everyday')

        # Deleting field 'Journal.in_pressa'
        db.delete_column(u'catalog_journal', 'in_pressa')
