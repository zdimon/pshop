...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Journal.in_category'
        db.add_column(u'catalog_journal', 'in_category',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Journal.in_category'
        db.delete_column(u'catalog_journal', 'in_category')
