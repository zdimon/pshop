...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Catalog.seo_content'
        db.add_column(u'catalog_catalog', 'seo_content',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

       
        # Adding field 'Catalog.seo_keywords'
        db.add_column(u'catalog_catalog', 'seo_keywords',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'catalog_importlog')
        ...
        # Deleting field 'Catalog.original_id'
        db.delete_column(u'catalog_catalog', 'original_id')

        # Deleting field 'Catalog.sorting'
        db.delete_column(u'catalog_catalog', 'sorting')

        # Deleting field 'Catalog.seo_content'
        db.delete_column(u'catalog_catalog', 'seo_content')

        # Deleting field 'Catalog.seo_title'
        db.delete_column(u'catalog_catalog', 'seo_title')

        # Deleting field 'Catalog.seo_keywords'
        db.delete_column(u'catalog_catalog', 'seo_keywords')
