...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Journal.count_for_pay'
        db.add_column(u'catalog_journal', 'count_for_pay',
                      self.gf('django.db.models.fields.IntegerField')(default=0, db_index=True),
                      keep_default=False)

        # Adding field 'Issue.is_empty'
        db.add_column(u'catalog_issue', 'is_empty',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Journal.count_for_pay'
        db.delete_column(u'catalog_journal', 'count_for_pay')

        # Deleting field 'Issue.is_empty'
        db.delete_column(u'catalog_issue', 'is_empty')
