...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CurrencyHistory.ru2dram'
        db.delete_column(u'catalog_currencyhistory', 'ru2dram')

        # Adding field 'CurrencyHistory.rub2dram'
        db.add_column(u'catalog_currencyhistory', 'rub2dram',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=4, decimal_places=4),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'CurrencyHistory.ru2dram'
        db.add_column(u'catalog_currencyhistory', 'ru2dram',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=4, decimal_places=4),
                      keep_default=False)

        # Deleting field 'CurrencyHistory.rub2dram'
        db.delete_column(u'catalog_currencyhistory', 'rub2dram')
    ...
    models = {
        ...
        u'catalog.currencyhistory': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'rub2dram': ('django.db.models.fields.DecimalField', [], {'max_digits': '4', 'decimal_places': '4'})
        },
        u'catalog.issue': {
