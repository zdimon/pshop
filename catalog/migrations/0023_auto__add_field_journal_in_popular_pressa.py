...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Journal.in_popular_pressa'
        db.add_column(u'catalog_journal', 'in_popular_pressa',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Journal.in_popular_pressa'
        db.delete_column(u'catalog_journal', 'in_popular_pressa')
