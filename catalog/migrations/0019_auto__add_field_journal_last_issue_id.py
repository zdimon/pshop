...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Journal.last_issue_id'
        db.add_column(u'catalog_journal', 'last_issue_id',
                      self.gf('django.db.models.fields.IntegerField')(default=0, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Journal.last_issue_id'
        db.delete_column(u'catalog_journal', 'last_issue_id')
